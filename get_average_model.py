...
########## 准备原始网络list ##########
    ...
    tmp_model.fc = nn.Linear(512, 10)   # 只有【有监督】local train才加这句 
    ...
    for client_id in test_clients:
        ...
        tmp_model.load_state_dict(torch.load('fedavg_net_client{}.pt'.format(client_id), map_location='cpu')) ### 加载【有监督】local train模型参数 ###
...
if __name__ == "__main__": #用于聚合并保存模型参数
    ...
    join_clients = 2.0 #参与聚合的client数量，用作参数平均，即test_clients长度
